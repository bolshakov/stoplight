...
RSpec.describe Stoplight::Wiring::Memory::Backend do
  ...
  describe "#state_store" do
    ...
    it "returns a state store" do
      is_expected.to be_kind_of(Stoplight::Infrastructure::Memory::Storage::State)
    end
  ...
  describe "#recovery_lock_store" do
    ...
    it "returns a recovery lock store" do
      is_expected.to be_kind_of(Stoplight::Infrastructure::Memory::Storage::RecoveryLock)
    end
  ...
  describe "#recovery_metrics_store" do
    ...
    it "returns a recovery metrics store" do
      is_expected.to be_kind_of(Stoplight::Infrastructure::Memory::Storage::RecoveryMetrics)
    end
  ...
  describe "#windowed_metrics_store" do
    ...
    it "returns a windowed metrics store" do
      is_expected.to be_kind_of(Stoplight::Infrastructure::Memory::Storage::WindowMetrics)
    end
  ...
  describe "#unbounded_metrics_store" do
    ...
    it "returns a unbounded metrics store" do
      is_expected.to be_kind_of(Stoplight::Infrastructure::Memory::Storage::UnboundedMetrics)
    end

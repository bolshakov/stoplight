...
In yellow state, Stoplight behaves differently from normal operation. Instead of running the block of code, it
first lets the underlying service cool down and then runs a test probe to see if the service has recovered.
Traffic Recovery strategies control how Stoplight behaves during this recovery phase.
